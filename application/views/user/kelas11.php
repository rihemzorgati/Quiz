        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Students! , This is a learnify folder page ! Please select the folders that you will access and the videos and materials are ready to be watched! Happy learning, students!</p>
                    <hr>
        ...
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/inggris_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/english.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/indo_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/french.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
