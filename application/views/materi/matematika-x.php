    ...
    <div class="container">
        <div class="row mt-4">
                    ...
                    <div class="card materi w-150 border-0">
                        <div class="card-body p-5">
                            ...
                            <div class="video_area" id="video">
                                ...
                                <a class="popup-youtube" href="https://drive.google.com/file/d/1r2wgpt4a2_LbeqgLX_wjx0V6s1DFniJz/view">
                ...
                <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
                    <div class="card materi w-150 border-0">
                        <div class="card-body p-5">
                            <h1 class="card-title">Test 2</h1>
                            <div class="video_area" id="video">
                                <img class="img-fluid" src="<?= base_url('assets/') ?>img/video-1.jpg" alt="" />
                                <a class="popup-youtube" href="https://drive.google.com/file/d/1cs5rlQbwxIv1o_yyM5TRZlx1vA4O3-tQ/view">
                                <img src="<?= base_url('assets/') ?>img/icon/video-icon-1.png" alt="" />
                                </a>
                            </div>
                        </div>
